...
// function AboutMe() {
//   return (
//     <div className="container my-5 about-wrapper">
//       <div className="card shadow-lg border-0 p-4 about-card bg-dark text-light">
...
//             <h3 className="fw-bold mb-3 text-warning">Hi, I’m Rudra Naskar 👋</h3>

//             <p className="text-light">
//               I’m a <strong>Backend-Focused Full-Stack Developer</strong> and{" "}
//               <strong>BCA student</strong> based in <strong>Kolkata, India</strong>,
//               currently pursuing my degree from the{" "}
//               <strong>Future Institute of Engineering and Management</strong>.
//               With a strong focus on backend technologies and scalable architecture,
//               I enjoy building powerful, efficient, and intuitive web applications.
//             </p>

//             <p className="text-light">
//               My expertise includes <strong>Java</strong>, <strong>Spring Boot</strong>,{" "}
//               <strong>React.js</strong>, and <strong>MySQL</strong>. I’ve gained
//               hands-on experience developing RESTful APIs, implementing CRUD operations,
//               and integrating database-driven systems. I’m also confident in working
//               with <strong>MongoDB</strong>, <strong>Docker</strong>, and modern development
//               tools such as <strong>Git</strong>, <strong>Postman</strong>, and{" "}
//               <strong>VS Code</strong>.
//             </p>

//             <p className="text-light">
//               I recently completed my internship at{" "}
//               <strong>Adamas Tech Consulting</strong> as a{" "}
//               <strong>Spring Boot Developer Intern</strong>, where I contributed to
//               backend API design and database integration for live client projects.
//             </p>

//             <p className="text-light">
//               Some of my key projects include <strong>RideSync</strong> – a car maintenance
//               scheduler built with Spring Boot and React, and{" "}
//               <strong>Greenlify</strong> – a smart waste management system using
//               React and Bootstrap for geo-location-based waste tracking.
//             </p>
...
//               <li className="list-inline-item badge bg-secondary me-2 mb-2">MongoDB</li>
...
//               </a>
//               <a
//                 href="https://www.linkedin.com/in/rudra-naskar653"
//                 target="_blank"
//                 rel="noopener noreferrer"
